...
#ifndef LOBEpTelemetryContainer_H_
#define LOBEpTelemetryContainer_H_

#include "TelemetryContainer.h"

#define LOBEp_CONTAINER_SIZE  37

class LOBEpTelemetryContainer : public TelemetryContainer
{
protected:
unsigned char telemetry[LOBEp_CONTAINER_SIZE];
...
#endif /* LOBEpTelemetryContainer_H_ */
